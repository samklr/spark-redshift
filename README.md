...
- **Without build tool**:
    ...
    spark-submit \
      --deploy-mode cluster \
      --master yarn \
      --packages com.amazon.redshift:redshift-jdbc42:2.2.0,org.apache.spark:spark-avro_2.12:3.5.7,io.github.spark-redshift-community:spark-redshift_2.12:6.5.0-spark_3.5 \
      my_script.py
    ```
